 ...
 * version 2.0
 */
package lib.com.jadarstudios.developercapes.asm;
...
public class DevCapesAccessTransformer implements IClassTransformer {
     ...
     */
    @Override
    public byte[] transform(final String name, final String newName, final byte[] bytes) {
