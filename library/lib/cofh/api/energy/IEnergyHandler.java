 ...
 * or more internal {@link IEnergyStorage} objects. A reference implementation is
...
public interface IEnergyHandler {
	...
	/**
	 * Returns true if the IEnergyHandler sends energy in the given direction. If energy is
	 * provided/produced on a given side should return true for that side.
	 */
