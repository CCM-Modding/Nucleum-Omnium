...
public class WorldGenMinableCluster extends WorldGenerator {
    ...
    public boolean generate(final World world, final Random rand, final int x, final int y,
        ...
        for (int l = 0; l <= this.genClusterSize; ++l) {
            ...
            final double d10 = (MathHelper.sin(l * (float) Math.PI / this.genClusterSize) + 1.0F)
                    * d9 + 1.0D;
            final double d11 = (MathHelper.sin(l * (float) Math.PI / this.genClusterSize) + 1.0F)
                    * d9 + 1.0D;
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                            for (int i3 = k1; i3 <= j2; ++i3) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D
                                        && block != null
                                        && block.isGenMineableReplaceable(world, k2, l2, i3,
                                                this.genBlockID)) {

                                    final WeightedRandomBlock ore = (WeightedRandomBlock) WeightedRandom
                                            .getRandomItem(world.rand, this.cluster);
