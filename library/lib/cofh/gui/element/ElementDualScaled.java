...
public class ElementDualScaled extends ElementBase {
    ...
    public void draw() {
        ...
        case 0:
            // vertical bottom -> top
            this.drawTexturedModalRect(this.posX, this.posY + this.sizeY - this.quantity,
                    this.sizeX, this.sizeY - this.quantity, this.sizeX, this.quantity);
            return;
        case 1:
            // horizontal left -> right
            this.drawTexturedModalRect(this.posX, this.posY, this.sizeX, 0, this.quantity,
                    this.sizeY);
            return;
        case 2:
            // horizontal right -> left
            this.drawTexturedModalRect(this.posX + this.sizeX - this.quantity, this.posY,
                    this.sizeX + this.sizeX - this.quantity, 0, this.quantity, this.sizeY);
            return;
        }
    }
