...
public abstract class GuiBase extends GuiContainer {
	...
	public void drawButton(	final String iconName,
							final int x,
							final int y,
	 ...
	 */
	/*
	 * public void drawFluid(final int x, final int y, final FluidStack fluid, final int width,
	 * final int height) { if ((fluid == null) || (fluid.getFluid() == null)) { return; }
	 * RenderHelper.setBlockTextureSheet(); drawTiledTexture(x, y, fluid.getFluid().getIcon(fluid),
	 * width, height); }
	 */
	...
	public void drawSizedTexturedModalRect(	final int x,
											final int y,
											final int u,
											final int v,
											final int width,
	...
	public void drawScaledTexturedModelRectFromIcon(final int x,
													final int y,
													final Icon icon,
													final int width,
													final int height) {
