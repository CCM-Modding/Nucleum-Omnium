...
public class VersionHandler
{
    ...
    public VersionHandler(final String name,
    ...
    private class VersionCheckThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try{
                ...
                if (beforeTargetVersion(VersionHandler.this.modVersion, VersionHandler.this.latestModVersion)){
                    VersionHandler.this.modLogger.log(Level.INFO, "An updated version of "
                                                                  + VersionHandler.this.modName
                                                                  + " is available: "
                    ...
                    if (beforeTargetVersion(MC_VERSION, VersionHandler.this.latestMCVersion)){
