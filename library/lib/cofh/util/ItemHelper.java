...
public final class ItemHelper {
	 ...
	 */
	/*
	 * public static boolean isPlayerHoldingFluidContainer(final EntityPlayer player) { return
	 * FluidContainerRegistry.isContainer(player.getCurrentEquippedItem()); }
	 */
	...
	public static boolean isPlayerHoldingItem(final Item item, final EntityPlayer player) {
		...
		final Item equipped = player.getCurrentEquippedItem() != null ? player.getCurrentEquippedItem()
																				.getItem() : null;
	...
	public static boolean isPlayerHoldingItemStack(final ItemStack stack, final EntityPlayer player) {
		...
		final ItemStack equipped = player.getCurrentEquippedItem() != null	? player.getCurrentEquippedItem()
																			: null;
	 ...
	 */
	public static boolean addItemStackToInventory(	final ItemStack[] inventory,
													ItemStack stack,
	...
	public static boolean areItemStacksEqualNoNBT(final ItemStack stackA, final ItemStack stackB) {
		...
		return (stackA.itemID == stackB.itemID) && (stackA.getItemDamage() == OreDictionary.WILDCARD_VALUE	? true
	...
	public static boolean craftingEquivalence(	final ItemStack checked,
