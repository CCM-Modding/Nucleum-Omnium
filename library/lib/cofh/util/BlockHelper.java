...
public final class BlockHelper {
    ...
    static {
        BlockHelper.rotateType[Block.wood.blockID] = RotationType.LOG;
        BlockHelper.rotateType[Block.dispenser.blockID] = RotationType.SIX_WAY;
        BlockHelper.rotateType[Block.railPowered.blockID] = RotationType.RAIL;
        BlockHelper.rotateType[Block.railDetector.blockID] = RotationType.RAIL;
        BlockHelper.rotateType[Block.pistonStickyBase.blockID] = RotationType.SIX_WAY;
        BlockHelper.rotateType[Block.pistonBase.blockID] = RotationType.SIX_WAY;
        BlockHelper.rotateType[Block.stoneSingleSlab.blockID] = RotationType.SLAB;
        BlockHelper.rotateType[Block.stairsWoodOak.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.chest.blockID] = RotationType.CHEST;
        BlockHelper.rotateType[Block.furnaceIdle.blockID] = RotationType.FOUR_WAY;
        BlockHelper.rotateType[Block.furnaceBurning.blockID] = RotationType.FOUR_WAY;
        BlockHelper.rotateType[Block.signPost.blockID] = RotationType.SIGN;
        BlockHelper.rotateType[Block.rail.blockID] = RotationType.RAIL;
        BlockHelper.rotateType[Block.stairsCobblestone.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.lever.blockID] = RotationType.LEVER;
        BlockHelper.rotateType[Block.pumpkin.blockID] = RotationType.PUMPKIN;
        BlockHelper.rotateType[Block.pumpkinLantern.blockID] = RotationType.PUMPKIN;
        BlockHelper.rotateType[Block.redstoneRepeaterIdle.blockID] = RotationType.REDSTONE;
        BlockHelper.rotateType[Block.redstoneRepeaterActive.blockID] = RotationType.REDSTONE;
        BlockHelper.rotateType[Block.stairsBrick.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.stairsStoneBrick.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.stairsNetherBrick.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.woodSingleSlab.blockID] = RotationType.SLAB;
        BlockHelper.rotateType[Block.stairsSandStone.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.enderChest.blockID] = RotationType.FOUR_WAY;
        BlockHelper.rotateType[Block.stairsWoodSpruce.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.stairsWoodBirch.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.stairsWoodJungle.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.stairsNetherQuartz.blockID] = RotationType.STAIRS;
        BlockHelper.rotateType[Block.hopperBlock.blockID] = RotationType.SIX_WAY;
        BlockHelper.rotateType[Block.railActivator.blockID] = RotationType.RAIL;
        BlockHelper.rotateType[Block.dropper.blockID] = RotationType.SIX_WAY;
    }
    ...
    public static int getCurrentMousedOverSide(final World world, final EntityPlayer player) {
        ...
        lookVec = posVec.addVector(lookVec.xCoord * distance, lookVec.yCoord * distance,
    ...
    public static TileEntity getAdjacentTileEntity(final TileEntity refTile,
        ...
        return BlockHelper.getAdjacentTileEntity(refTile.worldObj, refTile.xCoord, refTile.yCoord,
                refTile.zCoord, dir);
    }
    ...
    public static TileEntity getAdjacentTileEntity(final TileEntity refTile, final int side) {
        ...
        return BlockHelper.getAdjacentTileEntity(refTile.worldObj, refTile.xCoord, refTile.yCoord,
                refTile.zCoord, ForgeDirection.values()[side]);
    }
    ...
    public static int[] getAdjacentCoordinatesForSide(final int x, final int y, final int z,
        ...
        return new int[] { x + BlockHelper.SIDE_COORD_MOD[side][0],
                y + BlockHelper.SIDE_COORD_MOD[side][1], z + BlockHelper.SIDE_COORD_MOD[side][2] };
    }

    public static int[] getAdjacentCoordinatesForSide(final TileEntity tile, final int side) {

        return new int[] { tile.xCoord + BlockHelper.SIDE_COORD_MOD[side][0],
                tile.yCoord + BlockHelper.SIDE_COORD_MOD[side][1],
                tile.zCoord + BlockHelper.SIDE_COORD_MOD[side][2] };
    }

    public static int getLeftSide(final int side) {

        return BlockHelper.SIDE_LEFT[side];
    }

    public static int getRightSide(final int side) {

        return BlockHelper.SIDE_RIGHT[side];
    }

    public static int getOppositeSide(final int side) {

        return BlockHelper.SIDE_OPPOSITE[side];
    }

    public static int getAboveSide(final int side) {

        return BlockHelper.SIDE_ABOVE[side];
    }

    public static int getBelowSide(final int side) {

        return BlockHelper.SIDE_BELOW[side];
    }

    /* BLOCK ROTATION */
    public static boolean canRotate(final int blockId) {

        return BlockHelper.rotateType[blockId] != 0;
    }

    public static int rotateVanillaBlock(final World world, final int bId, int bMeta, final int x,
            final int y, final int z) {

        switch (BlockHelper.rotateType[bId]) {
        case RotationType.FOUR_WAY:
            return BlockHelper.SIDE_LEFT[bMeta];
        ...
        case RotationType.CHEST:
            ...
            for (int i = 2; i < 6; ++i) {
                ...
                if (world.getBlockId(coords[0], coords[1], coords[2]) == Block.chest.blockID) {
                    world.setBlockMetadataWithNotify(coords[0], coords[1], coords[2],
                            BlockHelper.SIDE_OPPOSITE[bMeta], 1);
                    return BlockHelper.SIDE_OPPOSITE[bMeta];
                }
            }
            return BlockHelper.SIDE_LEFT[bMeta];
    ...
    public static int rotateVanillaBlockAlt(final World world, final int bId, int bMeta,
        ...
        switch (BlockHelper.rotateType[bId]) {
        case RotationType.FOUR_WAY:
            return BlockHelper.SIDE_RIGHT[bMeta];
        case RotationType.SIX_WAY:
            if (bMeta < 6)
                return (bMeta + 5) % 6;
            return bMeta;
    ...
    public static List<ItemStack> breakBlock(final World worldObj, final int x, final int y,
        ...
        final List<ItemStack> stacks = Block.blocksList[blockId].getBlockDropped(worldObj, x, y, z,
                meta, fortune);
