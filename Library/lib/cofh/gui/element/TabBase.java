...
public abstract class TabBase extends ElementBase
{
    ...
    protected void drawBackground()
    {
        ...
        if (this.side == 0){
            ...
            this.gui.drawTexturedModalRect(this.posX - this.currentWidth, this.posY + 4, 0, (256 - this.currentHeight) + 4, 4, this.currentHeight - 4);
            this.gui.drawTexturedModalRect((this.posX - this.currentWidth) + 4, this.posY, (256 - this.currentWidth) + 4, 0, this.currentWidth - 4, 4);
            this.gui.drawTexturedModalRect(this.posX - this.currentWidth, this.posY, 0, 0, 4, 4);
            this.gui.drawTexturedModalRect((this.posX - this.currentWidth) + 4,
                                           this.posY + 4,
            ...
            this.gui.drawTexturedModalRect(this.posX, this.posY, 0, 256 - this.currentHeight, 4, this.currentHeight);
            this.gui.drawTexturedModalRect(this.posX + 4, this.posY, (256 - this.currentWidth) + 4, 0, this.currentWidth - 4, 4);
            this.gui.drawTexturedModalRect(this.posX, this.posY, 0, 0, 4, 4);
            this.gui.drawTexturedModalRect(this.posX + 4,
                                           this.posY + 4,
                                           (256 - this.currentWidth) + 4,
                                           (256 - this.currentHeight) + 4,
                                           this.currentWidth - 4,
