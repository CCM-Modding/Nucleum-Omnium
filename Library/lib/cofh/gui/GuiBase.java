...
public abstract class GuiBase extends GuiContainer
{
     ...
     * drawScaledTexturedModelRectFromIcon(x + i, y + j, fluid.getFluid().getIcon(fluid), drawWidth,
     * drawHeight);
     * }
     * }
     * GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0F);
    ...
    public void drawScaledTexturedModelRectFromIcon(final int x, final int y, final Icon theIcon, final int width, final int height)
    {
