...
public class FluidHelper
{
    ...
    /*
     * public static boolean fillTankWithContainer(World world, IFluidHandler handler, EntityPlayer
     * player)
     * {
     ...
     * return false;
     * }
     * public static boolean fillContainerFromTank(World world, IFluidHandler handler, EntityPlayer
     * player, FluidStack tankFluid)
     * {
     * ItemStack container = player.getCurrentEquippedItem();
     ...
     * return false;
     * }
     * public static int fillAdjacentHandler(TileEntity tile, int from, FluidStack fluid, boolean
     * doFill)
     * {
