package ccm.nucleum.configuration;
...
/**
 * This class offers advanced configurations capabilities, to "Enhance" normal Forge
 * Configurations.
 */
public class AdvConfiguration extends Configuration
{
    ...
    /**
     * Creates a configuration file for the file given in parameter.
     * And makes sure that the categories are case sensitive
     * 
     * @param configFile
     *            The File to make a Configuration File out of
     ...
     */
    public AdvConfiguration(final File configFile,
                            final boolean caseSensitiveCustomCategories)
    {
     ...
     * biomes.
     * EXA: ExtraBiomesXL, Biomes o' Plennty
     * Specifically, if your block is used BEFORE the Chunk is created, and placed in the terrain
     * byte array directly.
     ...
     * Normal mods such as '50 new ores' do not need to be below 256 so should use the normal
     * getBlock
     * 
     * @param category
     *            A custom Category in wich to put the block in
    ...
    {
        return super.getTerrainBlock(category, key, this.getTerrainFreeID(defaultID, Block.blocksList), comment);
    }
     ...
     * Configuration file, It saves them. Otherwise it doesn't do anything
     */
    @Override
    public void save()
    {
