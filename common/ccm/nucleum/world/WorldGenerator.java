...
public class WorldGenerator {
    ...
    public static void addOverworldGen(final String modName, final ItemStack stack,
        ...
        WorldGenerator.addWorldGen(modName, stack, oreName, clusterSize, numClusters, minY, maxY,
                enable, Block.stone);
    }
    ...
    private static void addWorldGen(String modName, final ItemStack stack, final String oreName,
        ...
        final boolean regen = NucleumWorld.config.get(modName, "RetroGen", enable).getBoolean(
                enable);
