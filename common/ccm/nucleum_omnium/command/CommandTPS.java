...
public class CommandTPS extends CommandBase {
	...
	public void processCommand(final ICommandSender sender, final String[] args) {
		if (args.length < 1) {
			...
			sender.sendChatToPlayer("Overall: " + CommandTPS.floatfmt.format(tps)
									+ " TPS/"
			...
			sender.sendChatToPlayer("TPS: " + CommandTPS.floatfmt.format(tps)
									+ " TPS of "
									+ CommandTPS.floatfmt.format(20L)
									+ " TPS ("
									+ (int) ((tps / 20.0D) * 100.0D)
									+ "%)");
			sender.sendChatToPlayer("Tick time: " + CommandTPS.floatfmt.format(tickms)
									+ " ms of "
									+ CommandTPS.floatfmt.format(50L)
									+ " ms");
			...
			sender.sendChatToPlayer("TPS: " + CommandTPS.floatfmt.format(tps)
									...
									+ (int) ((tps / 20.0D) * 100.0D)
									+ "%)");
			sender.sendChatToPlayer("Tick: " + CommandTPS.floatfmt.format(tickms)
									+ " ms of "
									+ CommandTPS.floatfmt.format(50L)
									+ " ms");
			sender.sendChatToPlayer("");
