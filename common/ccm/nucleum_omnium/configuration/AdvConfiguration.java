...
public class AdvConfiguration extends Configuration {
	...
	/**
	 * Gets or creates a block id property. If the block id property key is already in the
	 * configuration, then it will be used. Otherwise, defaultId will be used, except if already
	 ...
	 */
	@Override
	public Property getBlock(	final String category,
								final String key,
								final int defaultID,
	 ...
	 * This should ONLY be used by mods who do low level terrain generation, or ones
	 * that add new biomes. EXA: ExtraBiomesXL, Biomes o' Plennty Specifically, if your block is
	 * used BEFORE the Chunk is created, and placed in the terrain byte array directly. If
	 * you add a new biome and you set the top/filler block, they need to be <256, nothing else. If
	 * you're adding a new ore, DON'T call this function. Normal mods such as '50 new
	 ...
	 *            Normally a String containig the name of the block
	 * @param defaultID
	 *            the ID to be checked, in here it is checked to be less than 256, otherwise the
	 *            check begins at 1
	 * @param comment
	 *            A comment about the block
	 * @return A {@link Property} containig the ID of the block
	 */
	@Override
	public Property getTerrainBlock(final String category,
									final String key,
									final int defaultID,
									final String comment) {
	...
	/**
	 * Gets or creates a item id property. If the item id property key is already in the
	 * configuration, then it will be used. Otherwise, defaultId will be used, except if already
	 * taken, in which case this will try to determine a free default id.
	 * 
	 * @param key
	...
	/**
	 * Gets or creatse a item id property. If the item id property key is already in the
	 * configuration, then it will be used. Otherwise, defaultId will be used, except if already
	 * taken, in which case this will try to determine a free default id.
	 * 
	 * @param category
	...
	@Override
	public	Property
			getItem(final String category, final String key, final int defaultID, final String comment) {
	 ...
	 * 
	 * @param defaultID
	 *            The ID in which to begin the search. IT SHOULD BE < 256, if it is not it will be
	 *            set to 1
	 * @param array
